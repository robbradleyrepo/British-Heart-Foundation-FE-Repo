...
const typeMap: any = {
    ...
    "Navigation": o([
        { json: "node", js: "node", typ: a(r("Node")) },
        { json: "_level", js: "_level", typ: "" },
    ], false),
    "Node": o([
        { json: "node", js: "node", typ: u(undefined, a(r("Node"))) },
        { json: "_level", js: "_level", typ: "" },
        { json: "_parent", js: "_parent", typ: "" },
        { json: "_children", js: "_children", typ: "" },
        { json: "_grandchildren", js: "_grandchildren", typ: "" },
        { json: "_title", js: "_title", typ: "" },
        { json: "_link", js: "_link", typ: "" },
    ], false),
};
