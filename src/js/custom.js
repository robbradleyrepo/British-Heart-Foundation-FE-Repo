...
$(document).ready(function() {
    ...
    */
    var $shareItem = $('.c-share-this').find('.c-share-this__item');
    var pageTitle = $(document).find("title").length ? $(document).find("title").text() : 'BHF';
    var metaDesc = $('meta[name=description]').length ? $('meta[name=description]').attr("content") : 'Alternative description';
    var contentPicture = $('.c-text').find('img').first().length ? $('.c-text').find('img').attr("src") : $('.site-logo').find('img').attr("src");
    var domain = location.host;
    var currentURL = window.location.href;

    $shareItem.on('click', function (event) {
        ...
        switch($(this).attr('title').toLowerCase()) {
            ...
            case 'linkedin':
                var linkedinShareUrl = encodeURI('https://www.linkedin.com/shareArticle?mini=true&url=' + currentURL + '&title=' + pageTitle + '&summary=' + metaDesc + '&source=' + domain);
                window.open(linkedinShareUrl, '_blank');
                break;
            case 'facebook':
                var facebookShareUrl = encodeURI('https://www.facebook.com/sharer.php?caption=' + pageTitle + '&description=' + metaDesc + '&u=' + currentURL + '&picture=' + contentPicture);
                window.open(facebookShareUrl, '_blank');
                break;
            case 'twitter':
                var twitterShareUrl = encodeURI('https://twitter.com/intent/tweet?text=' + metaDesc.substring(0,101) + '...' + '&url=' + currentURL + '&via=TheBHF');
                window.open(twitterShareUrl, '_blank');
                break;
            case 'email':
                var mailTo = encodeURI('mailto:?subject=' + pageTitle + '&body=' + metaDesc);
    ...
    */
    var stores = [
        ...
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.53238562802762,
        //   "lng": -0.09324646205641329
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.52320112571971,
        //   "lng": -0.08603668422438204
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.520424050974924,
        //   "lng": -0.07676696986891329
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.5170058803432,
        //   "lng": -0.08226013393141329
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.51358745317048,
        //   "lng": -0.08706665248610079
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.51294646951477,
        //   "lng": -0.09461975307203829
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.51209181061047,
        //   "lng": -0.10697937221266329
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.51080979218935,
        //   "lng": -0.11865234584547579
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.508459331381424,
        //   "lng": -0.1303253194782883
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.505895054016946,
        //   "lng": -0.1426849386189133
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.5082456471131,
        //   "lng": -0.1495513936970383
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.50333063233518,
        //   "lng": -0.1509246847126633
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.502262080706764,
        //   "lng": -0.1605377218220383
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.502262080706764,
        //   "lng": -0.1722106954548508
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.49969745457042,
        //   "lng": -0.1831970235798508
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.50482656252161,
        //   "lng": -0.2003631612751633
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.506108749309405,
        //   "lng": -0.2140960714314133
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.498201356007925,
        //   "lng": -0.2044830343220383
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.49677467073,
        //   "lng": -0.1723480224609375
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.498201356007925,
        //   "lng": -0.1653442403767258
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.49670520833437,
        //   "lng": -0.19315338344313204
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.49884254711968,
        //   "lng": -0.1550445577595383
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.50653613688769,
        //   "lng": -0.10148620815016329
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.51123713567168,
        //   "lng": -0.07470703334547579
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.50311692401396,
        //   "lng": -0.08706665248610079
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.50083552254009,
        //   "lng": -0.12462615966796875
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.50397175128555,
        //   "lng": -0.10972595424391329
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.49520901154924,
        //   "lng": -0.1310119649861008
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.49691894672312,
        //   "lng": -0.1488647481892258
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        ...
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.50147667659363,
        //   "lng": -0.1421356201171875
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        ...
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.496918947130794,
        //   "lng": -0.1392517110798508
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        ...
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.49670520874204,
        //   "lng": -0.1873168966267258
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        ...
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.55352430111377,
        //   "lng": -0.07745361537672579
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.55950113407484,
        //   "lng": -0.08981323451735079
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.554378182480235,
        //   "lng": -0.08432007045485079
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.54092768902239,
        //   "lng": -0.07711029262281954
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.536443307531655,
        //   "lng": -0.06509399623610079
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.534734855499664,
        //   "lng": -0.07985687465406954
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.53067702491683,
        //   "lng": -0.06509399623610079
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.52277389569638,
        //   "lng": -0.05891418666578829
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.56312954233672,
        //   "lng": -0.2161560079548508
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.56590401213866,
        //   "lng": -0.1969299337361008
        // },
        // {
        //   "name": "Name 1",
        //   "address": "Address 1",
        //   "lat": 51.55544551164762,
        //   "lng": -0.2147827169392258
        // }
    ];
    ...
    */
    ...
    $(function() {
        ...
        var $triggerElem = $( ".animated" );

        if ($triggerElem.length) {

            var controller = new ScrollMagic.Controller();
            var triggerElemType = $triggerElem[0].tagName.toLowerCase();
            var newScene = null;
            
            switch (triggerElemType) {
                case 'section':

                    $triggerElem.each(function( index, elem ) {
                        ...
                        if (newScene.addIndicators.length ) {
    ...
    */
    var TotaliserComponent = (function () {

        function TotaliserComponent(theComponentSelector) {
            this.componentSelector = theComponentSelector;
            this.initTotaliserComponent();
        };

        TotaliserComponent.prototype.initTotaliserComponent = function () {
            this.makeAPICall(this.componentSelector);
        };

        TotaliserComponent.prototype.makeAPICall = function (componentSelector) {
            var $_self = $(componentSelector);
            var apiUrl = $_self.data('apiUrl');
            var $totalRaised = $_self.find('[data-total-raised]');
            var $totalConnected = $_self.find('[data-total-connected]');
            var $totalX = $_self.find('[data-total-x]');
            var that = this;

            if ($_self.data('apiUrl')) {
                $.get(apiUrl, function(data) {
                    if ($totalRaised.length > 0) {
                        $totalRaised.html(data.totalRaised);
                        $totalRaised.parent().css('width', $totalRaised.width() + 20);
                        that.initiateCounter($totalRaised);
                    }

                    if ($totalConnected.length > 0) {
                        $totalConnected.html(data.numberOfFundraisersConnected);
                        $totalConnected.parent().css('width', $totalConnected.width() + 20);
                        that.initiateCounter($totalConnected);
                    }

                    if ($totalX.length > 0) {
                        $totalX.html(data.totalX);
                        $totalX.parent().css('width', $totalX.width() + 20);
                        that.initiateCounter($totalX);
                    }
                });
            }
        };

        TotaliserComponent.prototype.initiateCounter = function ($element) {
            $element.counterUp({
                delay: 20,
                time: 1000,
                beginAt: 0,
        ...
        return TotaliserComponent;
    }());

    $(function () {
        var totaliserHolder = '.c-totaliser';

        $(totaliserHolder).each(function () {
            new TotaliserComponent($(this));
        });
    });
